...
R code used to create the diagram has since been lost and cannot be recovered. Your task is to come up with the code that will re-create the same chart making it look as close as possible to the original. A new dataset has been supplied – MovieReviewData.csv.
...
# testinng function
getXn(10) #should be 10
getXn(99) #should be 90
...
```{r}
# technically all number 1 - 99 will eventually create a cycle, I'm going to 
...
cat("The probablility I will not make it to the party is.", numFail/10000, "%\n")
```
...
The bootsrap estimates stay the same indicating a high level of precission and stability. 
