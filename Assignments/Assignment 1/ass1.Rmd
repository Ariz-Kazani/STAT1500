...
```{r}
# A function that takes a vector as a param
# Returns the sum and mean of a vector
...
```{r}
# A function that that takes a vector and a percentage as a peram
# Returns a new vector adjusted by the percentage
adjust_sales <- function(vector, percentage) {
  newVector <- vector * (percentage/100)
  sort(newVector, decreasing=TRUE)
  return(newVector)
}

adjust_sales(sales, 110)
