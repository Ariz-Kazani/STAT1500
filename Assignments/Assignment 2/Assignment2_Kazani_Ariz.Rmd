...
cat("The Probability that all of the prizes are won by the organizers is", pAllWin, "\n")
```
...
cat("The Probability that exactly two of the prizes are won by the organizers is", pAllWin, "\n")
```
...
cat("The Probability that exactly one of the prizes are won by the organizers is", pAllWin, "\n")
```
